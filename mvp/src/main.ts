...
import { Engine, DisplayMode, vec, FadeInOut, Color } from "excalibur";
...
export const player: Detective = new Detective(vec(7, 12));

game.goToScene<Detective>("overworld", { sceneActivationData: player });
